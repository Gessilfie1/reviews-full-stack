...
public class ReviewPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Review forrestGump = new Review("Forrest Gump", "Forrest Gump Review Content Here","Images//fgump.jpg",  drama, comedy);
		forrestGump = reviewRepo.save(forrestGump);
		
		Review unbreakable = new Review("Unbreakable", "Unbreakable Review Content Here","Images//unbreakable.jpg", drama, thriller);
		unbreakable = reviewRepo.save(unbreakable);
		
		Review toyStory = new Review("Toy Story", "Toy Story Review Content Here","Images//toystory.jpg", comedy, family);
		...
		Review theDeparted = new Review("The Departed", "The Departed Review Content Here","Images//departed.jpg", action, thriller);
